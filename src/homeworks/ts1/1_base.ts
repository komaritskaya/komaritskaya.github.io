...
// Ниже - number в "идеальных условиях" (в случае не идеального нейминга может быть unknown)
...
interface ITransformedCustomers {
  [key: number]: ICustomer;
}
export const transformCustomers = (customers: ICustomerWithId[]): ITransformedCustomers => {
  return customers.reduce((acc: ITransformedCustomers, customer: ICustomerWithId) => {
